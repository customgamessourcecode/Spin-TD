...
function Timers:HandleEventError(name, event, err)
  ...
  if TIMERS_SHOW_ERRORS then
    Notifications:BottomToAll({text="TIMER ERROR PLEASE PRINT SCREEN AND POST ON WORKSHOP PAGE", duration=240, style={color="red", ["font-size"]="24px", ["text-shadow"]="2px 2px 2px #98101E", ["background-color"]="#222222DD"}, continue=false})
  --Notifications:BottomToAll({text=name .. ' threw an error on event '..event, duration=240, style={color="red", ["font-size"]="16px", ["text-shadow"]="2px 2px 2px #98101E", ["background-color"]="#222222DD"}, continue=false})
    Notifications:BottomToAll({text=err, duration=240, style={color="red", ["font-size"]="18px", ["text-shadow"]="2px 2px 2px #98101E", ["background-color"]="#222222DD"}, continue=false})
  end
